...
namespace EightBall.Forms.WatchApp.WKExtension
{
	...
	partial class InterfaceController
	{
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		WatchKit.WKInterfaceLabel lastPredictionLabel { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (lastPredictionLabel != null) {
				lastPredictionLabel.Dispose ();
